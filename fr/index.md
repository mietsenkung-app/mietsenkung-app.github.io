...
<section class="hero">
  <div class="hero__inner">
    <div class="hero__copy" data-reveal>
      ...
      <div class="hero__cta">
        <a class="store-badge" href="https://apps.apple.com/ch/app/mietsenkung/id6765495437" aria-label="Télécharger Baisse-loyer sur l'App Store">
          <img src="{{ '/assets/badge-app-store-fr.svg' | relative_url }}" alt="Télécharger Baisse-loyer sur l'App Store" width="180" height="60" loading="lazy">
        </a>
        <a class="store-badge" href="https://play.google.com/store/apps/details?id=com.mietsenkung.mietsenkung" aria-label="Obtenir Baisse-loyer sur Google Play">
