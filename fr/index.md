...
description: Application suisse pour locataires. En 2 minutes elle vérifie si tu as droit à une baisse de loyer pour ton appartement et envoie la demande à ton·a bailleur·esse en un tap par Courrier A. Dès CHF 9.90.
lang: fr-CH
lang_short: fr
permalink: /fr/
---
  ...
  <div class="hero__inner">
    <div class="hero__copy" data-reveal>
      ...
      <div class="hero__cta">
        ...
        <a class="store-button" href="https://play.google.com/store/apps/details?id=com.mietsenkung.mietsenkung" target="_blank" rel="noopener" aria-label="Obtenir Baisse-loyer sur Google Play">
      ...
      <div class="hero__trust">
        <p class="hero__proof">Premières baisses de loyer déjà obtenues avec succès</p>
...
<section class="section media" id="media">
  <div class="section__inner">
    ...
    <h2 class="section-title" data-reveal>Dans les médias</h2>
    <div class="media__grid">
      ...
      <a class="media-card" href="{{ item.url }}" target="_blank" rel="noopener noreferrer" data-reveal>
        ...
        <span class="media-card__link">Voir le sujet<span class="media-card__arrow" aria-hidden="true">&rarr;</span></span>
      </a>
      {% endfor %}
    </div>
    <p class="media__soon" data-reveal>D'autres sujets suivront bientôt.</p>
  </div>
</section>
...
<section class="section">
  <div class="section__inner">
    ...
    <p class="section-lead" data-reveal>Ce qui distingue <strong>Baisse-loyer</strong> d'un modèle Word.</p>
  ...
  <div class="section__inner">
    ...
    <div class="pricing__grid">
      ...
      <article class="price-card price-card--featured" data-reveal>
        ...
        <p class="price-card__price-sub">une fois par lettre · envoi par Courrier A inclus</p>
        <ul class="price-card__list">
          ...
          <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Impression + envoi par Courrier A via notre partenaire postal suisse</li>
  ...
  <div class="section__inner">
    ...
    <div class="faq__list" data-reveal>
      ...
      <details>
        ...
        <div class="faq__answer">
          <p>L'app est gratuite. La vérification du droit et l'alerte taux le restent. Tu paies uniquement l'envoi de la lettre : CHF&nbsp;9.90 à 29.90 selon ton économie mensuelle. Inclus : génération de la lettre, impression et <strong>envoi par Courrier A</strong> par notre partenaire postal suisse.</p>
...
<section class="cta" id="download">
  <div class="cta__inner" data-reveal>
    ...
    <p>La vérification est gratuite. La lettre part dès CHF&nbsp;9.90, impression et <strong>envoi par Courrier A</strong> inclus. Si ton·a bailleur·esse reste silencieux·se ou refuse, <strong>Baisse-loyer</strong> t'accompagne jusqu'à l'autorité de conciliation.</p>
    <div class="hero__cta">
      <a class="store-button" href="https://apps.apple.com/app/id6765495437" target="_blank" rel="noopener" aria-label="Télécharger Baisse-loyer sur l'App Store">
        <svg class="store-button__icon" viewBox="0 0 384 512" fill="currentColor" aria-hidden="true"><path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/></svg>
        <span class="store-button__text">
