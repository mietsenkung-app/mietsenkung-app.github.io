...
<section class="hero">
  <div class="hero__inner">
    <div class="hero__copy" data-reveal>
      ...
      <div class="hero__cta">
        <a class="store-badge" href="https://apps.apple.com/ch/app/mietsenkung/id6765495437" aria-label="Mietsenkung im App Store laden">
          <img src="{{ '/assets/badge-app-store-de.svg' | relative_url }}" alt="Mietsenkung im App Store laden" width="180" height="60" loading="lazy">
        </a>
