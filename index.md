...
description: Schweizer App für Mieter*innen. In 2 Minuten prüft sie, ob dir eine Mietzinssenkung deiner Wohnung zusteht, und versendet das Senkungsbegehren mit einem Tap per A-Post. Ab CHF 9.90.
lang: de-CH
lang_short: de
permalink: /
---
...
<section class="hero">
  ...
  <div class="hero__inner">
    <div class="hero__copy" data-reveal>
      ...
      <p class="hero__sub">Du zahlst womöglich seit Jahren zu viel Miete für deine Wohnung. <strong>Mietsenkung</strong> berechnet deinen Anspruch nach Bundesrecht und versendet den Brief per <strong>A-Post</strong>. Bei Schweigen oder Ablehnung deiner Vermieter&ast;in begleitet dich die App weiter bis zur Schlichtungsbehörde. Die ersten Mieter&ast;innen zahlen dank der App schon weniger Miete.</p>

      <div class="hero__cta">
        <a class="store-button" href="https://apps.apple.com/app/id6765495437" target="_blank" rel="noopener" aria-label="Mietsenkung im App Store laden">
        ...
        <a class="store-button" href="https://play.google.com/store/apps/details?id=com.mietsenkung.mietsenkung" target="_blank" rel="noopener" aria-label="Mietsenkung bei Google Play laden">
...
<section class="section media" id="media">
  <div class="section__inner">
    <span class="eyebrow" data-reveal>Presse</span>
    <h2 class="section-title" data-reveal>In den Medien</h2>
    <div class="media__grid">
      ...
      <a class="media-card" href="{{ item.url }}" target="_blank" rel="noopener noreferrer" data-reveal>
        ...
        <span class="media-card__link">Zum Beitrag<span class="media-card__arrow" aria-hidden="true">&rarr;</span></span>
      </a>
      {% endfor %}
    </div>
    <p class="media__soon" data-reveal>Weitere Beiträge folgen in Kürze.</p>
  </div>
</section>
...
<section class="section steps" id="how">
  <div class="section__inner">
    ...
    <p class="section-lead" data-reveal>Du gibst deinen aktuellen Mietzins und das Datum der letzten Anpassung ein. Die App berechnet den Anspruch, generiert das Senkungsbegehren mit deiner Unterschrift und übergibt es der Schweizer Post. Reagiert dein&ast;e Vermieter&ast;in nicht oder lehnt ab, übernimmt die App auch den nächsten Schritt.</p>
    ...
    <div class="steps__grid">
      ...
      <article class="step" data-reveal>
        ...
        <p>Reagiert dein&ast;e Vermieter&ast;in nicht, erinnert die App dich nach 30 und 60 Tagen. Je nach Antwort schlägt sie den passenden Folgebrief vor: Erinnerungsschreiben bei Schweigen, Aufforderung zur Begründung bei Ablehnung, oder die Schlichtungsklage als letzten Schritt.</p>
...
<section class="stats">
  <div class="stats__inner">
    ...
    <p class="stats__lead" data-reveal>Nur ein Bruchteil der Berechtigten fordert die Senkung tatsächlich ein. Der Aufwand schreckt ab: Anspruch berechnen, Brief formulieren, Termine setzen, bei Schweigen oder Ablehnung den nächsten Schritt einleiten. <strong>Mietsenkung</strong> übernimmt diese Schritte vollständig, vom Anspruchs-Check bis zur Schlichtungsbehörde. Und es wirkt: die ersten Mieter&ast;innen zahlen dank der App weniger Miete.</p>
    ...
    <div class="stats__grid">
      ...
      <div class="stat" data-reveal>
        ...
        <p class="stat__label">durchschnittliche Jahresersparnis</p>
        <p class="stat__desc">Bei einer typischen 2.5-Zimmer-Wohnung à CHF&nbsp;1'920. Der Brief kostet einmalig CHF&nbsp;9.90 bis 29.90, du sparst jedes Jahr neu.</p>
      </div>
      <div class="stat" data-reveal>
  ...
  <div class="section__inner">
    ...
    <div class="bento">
      ...
      <article class="bento__card bento__d" data-reveal>
        ...
        <p>Pro Wohnung führt die App ein eigenes Verfahren: aktueller Anspruch, alle versendeten Briefe, Status pro Reaktion deiner Vermieter&ast;in (akzeptiert, teilweise, abgelehnt). Erinnerungen nach 30 und 60 Tagen, konkrete Vorschläge für den nächsten Schritt. Abgeschlossene Verfahren wandern ins Archiv, ein neues startet jederzeit.</p>
      </article>
      ...
      <article class="bento__card" data-reveal>
        ...
        <p>Wohnst du allein, mit Partner&ast;in oder in einer WG? Jede Mietpartei unterschreibt einzeln auf dem Gerät, der Brief wird automatisch in der richtigen Form formuliert. Verwaltet eine Firma deine Wohnung, findet die App die Adresse via Schweizer Firmen-Register. Privat-Vermieter&ast;innen tippst du einfach ein.</p>
      </article>
  ...
  <div class="section__inner">
    ...
    <div class="pricing__grid">
      ...
      <article class="price-card price-card--featured" data-reveal>
        ...
        <p class="price-card__name">Brief mit A-Post-Versand</p>
        <p class="price-card__price">CHF&nbsp;9.90<span style="font-size: 0.4em; color: var(--ink-soft); font-weight: 500;">&nbsp;bis 29.90</span></p>
        <p class="price-card__price-sub">einmalig pro Brief · A-Post-Versand inklusive</p>
        <ul class="price-card__list">
          <li>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
          ...
          <li>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
            Druck + A-Post-Versand durch Schweizer Post-Partner
          </li>
          <li>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>
  ...
  <div class="section__inner">
    ...
    <div class="faq__list" data-reveal>
      ...
      <details>
        ...
        <div class="faq__answer">
          <p>Die App selbst ist gratis. Der Anspruchs-Check und der Zins-Alarm sind dauerhaft kostenlos. Bezahlt wird nur der Brief-Versand: einmalig CHF&nbsp;9.90 bis 29.90, je nach deiner monatlichen Ersparnis. Im Preis enthalten: Brief-Generierung, Druck und <strong>A-Post-Versand</strong> durch unseren Schweizer Post-Partner.</p>
      ...
      <details>
        ...
        <div class="faq__answer">
          ...
          <p><strong>Mietsenkung</strong> ersetzt keine Rechtsberatung. Bei rechtlichen Fragen wende dich an einen kantonalen Mieterverband oder ein&ast;e Anwält&ast;in.</p>
        </div>
      </details>

      <details>
        <summary>Kann mich mein&ast;e Vermieter&ast;in kündigen weil ich ein Senkungsbegehren stelle?</summary>
        <div class="faq__answer">
      ...
      <details>
        <summary>Was, wenn mein&ast;e Vermieter&ast;in nicht antwortet?</summary>
        <div class="faq__answer">
...
<section class="section sources" id="sources">
  <div class="section__inner">
    ...
    <div class="sources-disclaimer">
      ...
      <p style="margin: 0;">Die App ist <strong>keine Rechtsberatung</strong> und ersetzt keine anwaltliche Vertretung. Bei rechtlichen Fragen wende dich an einen kantonalen Mieterverband oder ein&ast;e Anwält&ast;in.</p>
    </div>
  </div>
</section>
...
<section class="cta" id="download">
  <div class="cta__inner" data-reveal>
    ...
    <p>Anspruch prüfen ist gratis. Der Brief geht ab CHF&nbsp;9.90 inklusive Druck und <strong>A-Post-Versand</strong>. Bei Schweigen oder Ablehnung deiner Vermieter&ast;in begleitet dich <strong>Mietsenkung</strong> bis zur Schlichtungsbehörde.</p>
    <div class="hero__cta">
      <a class="store-button" href="https://apps.apple.com/app/id6765495437" target="_blank" rel="noopener" aria-label="Mietsenkung im App Store laden">
        <svg class="store-button__icon" viewBox="0 0 384 512" fill="currentColor" aria-hidden="true"><path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/></svg>
        <span class="store-button__text">
