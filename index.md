...
<section class="section barriers" id="barriers">
  <div class="section__inner">
    <span class="eyebrow" data-reveal>Warum die meisten nichts tun</span>
    <h2 class="section-title" data-reveal>Der Anspruch ist da. Das Gesetz ist klar. Aber drei Gründe halten die meisten ab.</h2>
    <p class="section-lead" data-reveal>Wenn der Referenzzinssatz sinkt, hast du laut Bundesrecht Anspruch auf eine Senkung. Trotzdem fordern nur 12&nbsp;% der Berechtigten aktiv ein. Hier sind die drei häufigsten Gründe und wie <strong>Mietsenkung</strong> sie löst.</p>

    <div class="barriers__grid">
      <article class="barrier" data-reveal>
        <span class="barrier__num">01</span>
        <h3>«Ich wusste gar nicht, dass ich das kann»</h3>
        <p>Der Referenzzinssatz wird im Bundesblatt veröffentlicht. Vermieter*innen müssen Senkungen nicht aktiv mitteilen. Tausende Mieter*innen zahlen jahrelang zu viel, ohne je etwas zu unternehmen.</p>
        <p class="barrier__solution"><strong>Mietsenkung</strong> überwacht den Referenzzinssatz und meldet sich proaktiv, sobald du Anspruch hast.</p>
      </article>

      <article class="barrier" data-reveal>
        <span class="barrier__num">02</span>
        <h3>«Ich habe die Frist verpasst»</h3>
        <p>Ein Senkungsbegehren muss rechtzeitig auf den nächsten Kündigungstermin gestellt werden. Sobald der vorbei ist, wartest du wieder ein Quartal auf die Reduktion.</p>
        <p class="barrier__solution"><strong>Mietsenkung</strong> berechnet den nächstmöglichen Kündigungstermin automatisch und versendet rechtzeitig per Post.</p>
      </article>

      <article class="barrier" data-reveal>
        <span class="barrier__num">03</span>
        <h3>«Ich habe Angst vor der Reaktion meiner Vermieter*in»</h3>
        <p>Viele Mieter*innen befürchten, dass eine Senkungsanfrage das Verhältnis belastet. Die Angst ist verständlich. Das Recht aber ist eindeutig: Art.&nbsp;271a&nbsp;OR schützt dich vor Rachekündigungen über drei Jahre nach einer berechtigten Forderung.</p>
        <p class="barrier__solution"><strong>Mietsenkung</strong> formuliert sachlich-juristisch korrekt. Tausende fordern jährlich Senkungen ohne Konsequenzen.</p>
      </article>
    </div>
  </div>
</section>
...
<section class="section savings" id="savings">
  <div class="section__inner">
    <span class="eyebrow" data-reveal>Was dein Anspruch wert ist</span>
    <h2 class="section-title" data-reveal>Je mehr Senkungs-Stufen du verpasst hast, desto mehr Geld liegt auf dem Tisch.</h2>
    <p class="section-lead" data-reveal>Der Referenzzinssatz ist seit 2023 viermal gesunken: von 1.75&nbsp;% über 1.50&nbsp;% auf heute 1.25&nbsp;%. Pro Senkungs-Schritt von 0.25 Prozentpunkten hast du laut Art.&nbsp;13&nbsp;VMWG Anspruch auf rund <strong>2.91&nbsp;%</strong> tiefere Nettomiete. Eine grobe Orientierung:</p>

    <div class="savings__table-wrap" data-reveal>
      <table class="savings__table">
        <thead>
          <tr>
            <th>Senkungs-Stufen offen</th>
            <th>Bruttosenkung</th>
            <th>Miete 1'200&nbsp;.–</th>
            <th>Miete 1'800&nbsp;.–</th>
            <th>Miete 2'400&nbsp;.–</th>
        ...
        <tbody>
          <tr>
            <td>1 Stufe<br><span class="savings__hint">letzte Anpassung auf 1.50&nbsp;%</span></td>
            <td>2.91&nbsp;%</td>
            <td>CHF&nbsp;419 / Jahr</td>
            <td>CHF&nbsp;629 / Jahr</td>
            <td>CHF&nbsp;838 / Jahr</td>
          ...
          <tr>
            <td>2 Stufen<br><span class="savings__hint">letzte Anpassung auf 1.75&nbsp;%</span></td>
            <td>5.73&nbsp;%</td>
            <td>CHF&nbsp;825 / Jahr</td>
            <td>CHF&nbsp;1'238 / Jahr</td>
            <td>CHF&nbsp;1'650 / Jahr</td>
          </tr>
          <tr>
            <td>3 Stufen<br><span class="savings__hint">letzte Anpassung auf 2.00&nbsp;%</span></td>
            <td>8.47&nbsp;%</td>
            <td>CHF&nbsp;1'220 / Jahr</td>
            <td>CHF&nbsp;1'830 / Jahr</td>
            <td>CHF&nbsp;2'440 / Jahr</td>
          </tr>
          <tr>
            <td>5 Stufen<br><span class="savings__hint">letzte Anpassung auf 2.50&nbsp;%</span></td>
            <td>13.68&nbsp;%</td>
            <td>CHF&nbsp;1'970 / Jahr</td>
            <td>CHF&nbsp;2'955 / Jahr</td>
            <td>CHF&nbsp;3'940 / Jahr</td>
          </tr>
        </tbody>
      </table>
    </div>
    <p class="savings__note" data-reveal>Die obenstehende Bruttosenkung ist nur die halbe Wahrheit. Das Gesetz erlaubt der Vermieter*in, eine pauschale Kostensteigerung von <strong>0.5&nbsp;% pro Jahr</strong> seit der letzten Anpassung sowie <strong>40&nbsp;% der Teuerung</strong> (LIK, Art.&nbsp;16&nbsp;VMWG) gegenzurechnen. <strong>Mietsenkung</strong> macht beide Gegenrechnungen automatisch und zeigt dir den Netto-Anspruch, den du tatsächlich einfordern kannst, nach Bundesrecht durchgerechnet.</p>
  </div>
</section>
