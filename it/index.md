...
<section class="hero">
  <div class="hero__inner">
    <div class="hero__copy" data-reveal>
      ...
      <div class="hero__cta">
        <a class="store-badge" href="https://apps.apple.com/ch/app/mietsenkung/id6765495437" aria-label="Scarica Ribassoaffitto su App Store">
          <img src="{{ '/assets/badge-app-store-it.svg' | relative_url }}" alt="Scarica Ribassoaffitto su App Store" width="180" height="60" loading="lazy">
        </a>
        <a class="store-badge" href="https://play.google.com/store/apps/details?id=com.mietsenkung.mietsenkung" aria-label="Disponibile su Google Play">
          <img src="{{ '/assets/badge-google-play-it.png' | relative_url }}" alt="Disponibile su Google Play" width="180" height="54" loading="lazy">
        </a>
      </div>
