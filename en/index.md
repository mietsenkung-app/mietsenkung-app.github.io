...
<section class="hero">
  <div class="hero__inner">
    <div class="hero__copy" data-reveal>
      ...
      <div class="hero__cta">
        <a class="store-badge" href="https://apps.apple.com/ch/app/mietsenkung/id6765495437" aria-label="Download RentReducer on the App Store">
          <img src="{{ '/assets/badge-app-store-en.svg' | relative_url }}" alt="Download RentReducer on the App Store" width="180" height="60" loading="lazy">
        </a>
        <a class="store-badge" href="https://play.google.com/store/apps/details?id=com.mietsenkung.mietsenkung" aria-label="Get RentReducer on Google Play">
          <img src="{{ '/assets/badge-google-play-en.png' | relative_url }}" alt="Get it on Google Play" width="180" height="54" loading="lazy">
        </a>
      </div>
